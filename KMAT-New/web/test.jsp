<%-- 
    Document   : test
    Created on : Oct 14, 2016, 11:53:19 AM
    Author     : Saim
--%>
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<body>
			...
			<header id="header-section">
				<div class="container">
					<div class="nav-header">
						...
						<h1 id="logo"><a href="index.html">Energy</a></h1>
						<!-- START #menu-wrap -->
								...
								<li>
									<a href="services.html" class="fh5co-sub-ddown">Services</a>
									 <ul class="sub-menu">
										...
										<li>
											<a href="#" class="fh5co-sub-down">Free HTML5</a>
											<ul class="sub-menu">
		...
		<div class="parallax parallax2" style="background-image: url(images/hero.jpg);" data-stellar-background-ratio="0.5">
		...
		<div id="blog-section" class="grey-bg">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center heading">
		...
		<div class="parallax" style="background-image: url(images/hero2.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center table">
		...
		<div id="counter-section" class="counters">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center heading">
				...
				<div class="row">
					<div class="col-md-3 text-center">
						<span class="counter js-counter" data-from="0" data-to="1356" data-speed="5000" data-refresh-interval="50"></span>
						<span class="counter-label">Cups of Coffee</span>
					</div>
					<div class="col-md-3 text-center">
						<span class="counter js-counter" data-from="0" data-to="7290" data-speed="5000" data-refresh-interval="50"></span>
						<span class="counter-label">Client</span>
					</div>
					<div class="col-md-3 text-center">
						<span class="counter js-counter" data-from="0" data-to="4370" data-speed="5000" data-refresh-interval="50"></span>
						<span class="counter-label">Projects</span>
					</div>
					<div class="col-md-3 text-center">
						<span class="counter js-counter" data-from="0" data-to="4000" data-speed="5000" data-refresh-interval="50"></span>
						<span class="counter-label">Finished Projects</span>
					</div>
				</div>
			</div>
		</div>
