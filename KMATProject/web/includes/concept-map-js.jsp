<%-- 
    Document   : concept-map-js
    Created on : Nov 3, 2016, 10:21:31 AM
    Author     : Saim
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<script src="js/process-ladder/process-ladders-view-for-concepts.js"></script>
...
<script src="js/process-ladder/concept-map-creator.js"></script>
