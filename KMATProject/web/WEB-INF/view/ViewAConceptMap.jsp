...
<html>
	<head>
		...
		<meta name="description" content="Create a new concept map for Knowledge Management for All Tool - KMAT" />
                        ...
                        <div class="col-md-10 col-md-push-2">
                            ...
                            <div id = "ladder-header-row" class="row">
                                ...
                                <div class="col-md-5 col-md-offset-3">
                                    <div>
										<label id="view-ladder-name">Concept Map Name: </label>
									</div>
                                </div>
