				...
				if(!d3.event.shiftKey && !thisGraph.state.shiftNodeDrag)
				{
					...
					if(thisGraph.state.selectedNode)
					{
                                            if (thisGraph.state.selectedNode.nodeType === "PROCESS")
                                                ...
                                                d3.select(this).classed("selectedC", true);
                                            thisGraph.removeSelectFromNode();
					}
		...
		//newGs.classed(d.classforSelection, true)
			...
			.on("dblclick", function(d)
			{
				if(!thisGraph.state.justDragged && !d3.event.shiftKey && !thisGraph.state.shiftNodeDrag)
				{
					...
					{
                                            if (thisGraph.state.selectedNode.nodeType === "PROCESS")
                                                d3.select(this).classed("selectedP circle", true);
                                            else if (thisGraph.state.selectedNode.nodeType === "CONCEPT")
                                                d3.select(this).classed("selectedG circle", true);
                                            else if (thisGraph.state.selectedNode.nodeType === "COMPOSITION")
                                                d3.select(this).classed("selectedC circle", true);
                                            thisGraph.removeSelectFromNode();
					}
