...
public class ToolDAO {
    ...
    public static ToolBean insertTool(ToolBean bean){
        ...
        String insert_query = "insert into tool_details(tool_idfk, tool_name, tool_description, main_name, main_ext, user_idfk"
                + "tool_input, tool_output, tool_added, tool_updated)"+"VALUES(?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())";
            ...
            if(toolName != "" && toolDescription != "" ){
                ...
                if(more){
                    ...
                    if(rs.next()){
                        ...
                        pst.setInt(6, userID);
                        pst.setBoolean(7, input);
                        pst.setBoolean(8, output);
                        pst.executeUpdate();
                        tool_details_insertion = pst.executeUpdate();
    ...
    public static ArrayList<ToolBean> getTools(String curntUser){
        ...
        try{
            ...
            String q2 = "select tool_details_id, tool_name from tool_details where iser_idfk = '"+uid+"'";
