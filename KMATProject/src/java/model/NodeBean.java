...
public class NodeBean implements java.io.Serializable
{
	...
	public NodeBean(String name, double posX, double posY)
	{
		this.name = name;
	...
	public NodeBean(int id, int nodeId, int ladderId, int ownerId, NodeBean.NodeType nodeType, String name, String description, double posX, double posY, Timestamp createdt, Timestamp updatedt)
	{
		this.id = id;
		this.nodeId = nodeId;
	...
	{
		return "NodeBean{" + "id=" + id + ", nodeId=" + nodeId + ", ladderId=" + ladderId + ", ownerId=" + ownerId + ", nodeType=" + nodeType + ", name=" + name + ", description=" + description + ", toolIds=" + toolIds + ", resourceIds=" + resourceIds + ", sharedUserIds=" + sharedUserIds + ", nodePosition=(" + nodePosition.getX() + "," + nodePosition.getY() + "), createDate=" + createDate + ", updateDate=" + updateDate + '}';
	}
